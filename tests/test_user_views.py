...
# ------------------- TESTS PARA CRUD COMPLETO -------------------
    ...
    def test_admin_can_retrieve_user_detail(self, api_client, admin_user, client_user, get_token):
    ...
    def test_user_can_retrieve_other_user_detail(self, api_client, client_user, admin_user, get_token):
    ...
    def test_admin_can_update_user(self, api_client, admin_user, client_user, get_token):
    ...
    def test_admin_can_delete_user(self, api_client, admin_user, client_user, get_token):
    ...
    def test_user_can_delete_other_user(self, api_client, client_user, admin_user, get_token):
    ...
    def test_classic_login_invalid_credentials(self, api_client):
        ...
        assert response.status_code == 401, f"Expected 401, got {response.status_code}"
        assert 'credenciales' in response.data['error'].lower() or 'inválidas' in response.data['error'].lower()
    ...
    def test_get_serializer_class_for_partial_update(self, api_client, admin_user, get_token):
    ...
    def test_change_password_with_incorrect_old_password(self, api_client, client_user, get_token):
    ...
    @pytest.mark.django_db
    def test_partial_update_uses_correct_serializer(self, api_client, client_user, get_token):
